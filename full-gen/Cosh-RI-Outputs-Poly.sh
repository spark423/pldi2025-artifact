...
./Cos-RI-Outputs ../intervals/coshcos_ri_outputs_p1_uq ../polynomials/coshcos_ri_inputs_p1 5
echo -e "Polynomial generation complete."
echo -e "Generating the 1st sin polynomial for cosh."
./Sin-RI-Outputs ../intervals/coshsin_ri_outputs_p1_uq ../polynomials/coshsin_ri_inputs_p1 5
echo -e "Polynomial generation complete."
