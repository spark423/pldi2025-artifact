...
./Log-RI-Inputs ../intervals/log_ri_inputs_p1_uq ../polynomials/log_ri_inputs_p1 20
echo -e "Polynomial generation complete."
echo -e "Generating the 2nd polynomial for log."
./Log-RI-Inputs ../intervals/log_ri_inputs_p2_uq ../polynomials/log_ri_inputs_p2 20
echo -e "Polynomial generation complete."
