...
./Log10-RI-Inputs ../intervals/log10_ri_inputs_p3_uq ../polynomials/log10_ri_inputs_p3 20
echo -e "Polynomial generation complete."
echo -e "Generating the 4th polynomial for log10."
./Log10-RI-Inputs ../intervals/log10_ri_inputs_p4_uq ../polynomials/log10_ri_inputs_p4 20
echo -e "Polynomial generation complete."
