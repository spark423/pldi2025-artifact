...
./Cos-RI-Outputs ../intervals/cospicos_ri_outputs_p1_uq ../polynomials/cospicos_ri_inputs_p1 5
echo -e "Polynomial generation complete."
echo -e "Generating the 1st sin polynomial for cospi."
./Sin-RI-Outputs ../intervals/cospisin_ri_outputs_p1_uq ../polynomials/cospisin_ri_inputs_p1 5
echo -e "Polynomial generation complete."
