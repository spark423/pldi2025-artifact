...
./Cos-RI-Inputs ../intervals/sinpicos_ri_inputs_p1_uq ../polynomials/sinpicos_ri_inputs_p1 5
echo -e "Polynomial generation complete."
echo -e "Generating the 1st sin polynomial for sinpi."
./Sin-RI-Inputs ../intervals/sinpisin_ri_inputs_p1_uq ../polynomials/sinpisin_ri_inputs_p1 5
echo -e "Polynomial generation complete."
