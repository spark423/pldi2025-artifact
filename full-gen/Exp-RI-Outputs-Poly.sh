...
./Exp-RI-Outputs ../intervals/exp_ri_outputs_p1_uq ../polynomials/exp_ri_outputs_p1 10
echo -e "Polynomial generation complete."
echo -e "Generating the 2nd polynomial for exp."
./Exp-RI-Outputs ../intervals/exp_ri_outputs_p2_uq ../polynomials/exp_ri_outputs_p2 10
echo -e "Polynomial generation complete."
