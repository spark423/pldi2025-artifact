...
double ourlibm_cospif(float x) {
  ...
  double z2 = z*z;
  //y=0x1.000000000000dp+0 x^(0) + -0x1.3bd3cca1574b1p+2 x^(2) + 0x1.03dc6f9c594f1p+2 x^(4)
  double cospiZ = z2*0x1.03dc6f9c594f1p+2-0x1.3bd3cca1574b1p+2;
  cospiZ = cospiZ*z2+0x1.000000000000dp+0;
  //y=0x1.921fb54442ep+1 x^(1) + -0x1.4abbcf134d6d6p+2 x^(3) + 0x1.4d0a6323ca8cbp+1 x^(5)
  double sinpiZ = z2*0x1.4d0a6323ca8cbp+1-0x1.4abbcf134d6d6p+2;
  sinpiZ = z*(sinpiZ*z2+0x1.921fb54442ep+1);
