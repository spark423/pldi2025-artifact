...
double ourlibm_sinf_fma(float x) {
  ...
  if (b < 0xff000000) {
	...
	a = (p2l<<(s-57))|(p1l>>(121-s));
      ...
      double cospiK = sinpiMBy256TwoPi[(k+128)&511];
      double cospiZ;
      if (__builtin_expect(z == -0x1.9edbe364d3554p-2, 0)) cospiZ = 0x1.fffe607c36b9p-1;
      else if (__builtin_expect(z == -0x1.9e45991d9013dp-2, 0)) cospiZ = 0x1.fffe61f4c5fa6p-1;
      ...
      else if (__builtin_expect(z == 0x1.7e6cc7d404d3ap-2, 0)) cospiZ = 0x1.fffe9ee4b47a3p-1;
      else {
	//-0x1.9edbe364d3554p-2, -0x1.9e45991d9013dp-2, -0x1.1b7ecacfe4f68p-3, -0x1.b4f365d6c2c58p-4, -0x1.6946952e477ep-7, 0x1.0e8ae19d51ea4p-4, 0x1.73b15119dad6fp-2, 0x1.7e6cc7d404d3ap-2 
	//y=0x1.fffffffffffffp-1 x^(0) + -0x1.3bd3cc9b98a61p-14 x^(2) + 0x1.03c2e3f873a43p-30 x^(4)
	cospiZ = __builtin_fma(z2, 0x1.03c2e3f873a43p-30, -0x1.3bd3cc9b98a61p-14);
