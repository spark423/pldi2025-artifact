...
double rlibm_exp10f(float x) {
  ...
  double y = 0.0;
  if (__builtin_expect(R == -0x1.b9fe7dec10c04p-9, 0)) y = 0x1.fc0a35be05c76p-1;
  else if (__builtin_expect(R == -0x1.753fc710c903p-9, 0)) y = 0x1.fca75f146505ap-1;
  ...
  else if (__builtin_expect(R == 0x1.fb29438864818p-10, 0)) y = 0x1.0124993c269dap+0;
  else if (__builtin_expect(R == 0x1.4c203a2d1299p-9, 0)) y = 0x1.017f7d8b0151cp+0;
  else if (__builtin_expect(R == 0x1.636b2b1e6bc94p-9, 0)) y = 0x1.019a78e41dc74p+0;
  else if (__builtin_expect(R == 0x1.d924c938aa7bcp-9, 0)) y = 0x1.0222feead7746p+0;
  else { 
    //-0x1.b9fe7dec10c04p-9, -0x1.753fc710c903p-9, -0x1.0c34ef4921aa8p-9, -0x1.f0ed19f04c8c8p-10, 0x1.e2c509064408p-12, 0x1.fb29438864818p-10, 0x1.4c203a2d1299p-9, 0x1.636b2b1e6bc94p-9, 0x1.d924c938aa7bcp-9
    //y=0x1.ffffffffffffep-1 x^(0) + 0x1.26bb1bbb55a0ep+1 x^(1) + 0x1.53524c73a0b67p+1 x^(2) + 0x1.047056399852cp+1 x^(3) + 0x1.2bd80fd573b3ap+0 x^(4) + 0x1.1d92575be0858p-1 x^(5)
    double coeffs[6] = {0x1.ffffffffffffep-1, 0x1.26bb1bbb55a0ep+1, 0x1.53524c73a0b67p+1, 0x1.047056399852cp+1, 0x1.2bd80fd573b3ap+0, 0x1.1d92575be0858p-1};
    double R2 = R*R;
    double R4 = R2*R2;
