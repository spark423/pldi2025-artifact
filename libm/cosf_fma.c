...
double ourlibm_cosf_fma(float x) {
  float_x fX = {.f=x};
  uint32_t b = fX.x<<1;
  if (b < 0xff000000) {
    int k;
	...
	//y=0x1.fffffffffffffp-1 x^(0) + -0x1.3bd3cc9c7b384p-14 x^(2) + 0x1.03c4974184343p-30 x^(4)
	cospiZ = __builtin_fma(z2, 0x1.03c4974184343p-30, -0x1.3bd3cc9c7b384p-14);
	...
	a = (p2l<<(s-57))|(p1l>>(121-s));
      ...
      double cospiK = sinpiMBy256TwoPi[(k+128)&511];
      double cospiZ;
      if (__builtin_expect(z == -0x1.cbb16f97e0975p-2, 0)) cospiZ = 0x1.fffe036df6a1ep-1;
	...
	//-0x1.cbb16f97e0975p-2, -0x1.5d823ac42b395p-2, -0x1.0788e4762434p-2, -0x1.a9e8818a3af1ap-3, -0x1.aafc551c92bf8p-4, -0x1.7dcb0e32af9b4p-4, -0x1.3d5cf3c8209fp-6, 0x1.8155d60fb924p-3, 0x1.58f335ff0f9d9p-2                                           
	//y=0x1.fffffffffffffp-1 x^(0) + -0x1.3bd3cc9b6a7ccp-14 x^(2) + 0x1.03bf8f0057a8p-30 x^(4)
	cospiZ = __builtin_fma(z2, 0x1.03bf8f0057a8p-30, -0x1.3bd3cc9b6a7ccp-14);
	cospiZ = __builtin_fma(cospiZ,z2,0x1.fffffffffffffp-1);
      }
