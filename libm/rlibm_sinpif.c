...
double rlibm_sinpif(float x) {
  ...
  double z2 = z*z;
  //y=0x1.0000000000005p+0 x^(0) + -0x1.3bd3cca01d573p+2 x^(2) + 0x1.03d32edaa915dp+2 x^(4)
  double cospiZ = z2*0x1.03d32edaa915dp+2-0x1.3bd3cca01d573p+2;
  cospiZ = cospiZ*z2+0x1.0000000000005p+0;
  //y=0x1.921fb54442d18p+1 x^(1) + -0x1.4abbce6a933cap+2 x^(3) + 0x1.46e6668b6974ap+1 x^(5)
  double sinpiZ = z2*0x1.46e6668b6974ap+1-0x1.4abbce6a933cap+2;
  sinpiZ = z*(sinpiZ*z2+0x1.921fb54442d18p+1);
