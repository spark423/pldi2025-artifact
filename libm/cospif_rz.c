...
double rlibm_cospif_rz(float x) {
  ...
  //y=0x1.000000000000dp+0 x^(0) + -0x1.3bd3cca1796b4p+2 x^(2) + 0x1.03dd460817e89p+2 x^(4)
  double cospiZ = rz_add(rz_multiply(z2, 0x1.03dd460817e89p+2), -0x1.3bd3cca1796b4p+2);
  cospiZ = rz_add(rz_multiply(cospiZ, z2), 0x1.000000000000dp+0);
  //y=0x1.921fb54442ep+1 x^(1) + -0x1.4abbcf128b785p+2 x^(3) + 0x1.4d035ebe83081p+1 x^(5)
  double sinpiZ = rz_add(rz_multiply(z2, 0x1.4d035ebe83081p+1), -0x1.4abbcf128b785p+2);
  sinpiZ = rz_multiply(z, rz_add(rz_multiply(sinpiZ, z2), 0x1.921fb54442ep+1));
