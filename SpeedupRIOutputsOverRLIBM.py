...
for i in range(0, len(labels)) :
    speedup.append(round(((rlibm_time[i] / ri_outputs_time[i])-1)*100))
...
ax.set_ylim(0, 100)
rects = ax.bar(x, speedup2, width, color="tab:green", label="Rounding-invariant Outputs", zorder = 100)
...
plt.savefig('rounding_invariant_outputs_over_rlibm.png', bbox_inches='tight', pad_inches = -0.001)
