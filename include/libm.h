...
double ourlibm_cosf_fma(float);
double ourlibm_coshf_fma(float);
double ourlibm_cospif_fma(float);
double ourlibm_expf_fma(float);
double ourlibm_expf_fma(float);
double ourlibm_exp2f_fma(float);
double ourlibm_exp10f_fma(float);
double ourlibm_logf_fma(float);
double ourlibm_log2f_fma(float);
double ourlibm_log10f_fma(float);
double ourlibm_sinf_fma(float);
double ourlibm_sinhf_fma(float);
double ourlibm_sinpif_fma(float);
